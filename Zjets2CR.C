...
// Change of directory//
std::vector<std::string> directories = {"/Zjets2/" /*, "/emCR_B/", "/emCR_A/" , "/Zjets/" , "/SR/"*/};
...
int Zjets2CR()
{
    ...
    for (const auto &directory : directories)
    {
        ...
        cout << " The purity of Zjets2 is (%): " << (100 * Zjets) / (Zjets + SignalZZ + WZ + WW + AllTop + llklp) << endl;
        ...
        cout << " Zjets scaled are " << scaleZjets2 * Zjets << endl;
    }
    ...
    // scaling for Zjets1
    HZjetsscaled->Scale(scaleZjets2);
    cout << " Integral of HZjets, which is equivalent with the weighted and counted events is " << HZjetsscaled->Integral() << endl;
    cout << " Integral of HZjets, which is equivalent with the counted entries is " << HZjets->Integral() << endl;

    // HTops->Scale(1.011241);
    // HZjets->Scale(1.066263);
    // HWZ->Scale(1.023562);
    // HWW->Scale(1.460575);
    ...
    TLatex *tex2 = new TLatex(0.1, 0.70, "Zjets(#geq 2)CR");
    tex2->SetNDC();
    tex2->SetTextFont(12);
    tex->SetTextSize(0.03); // Adjust the value to make the text smaller
    tex2->SetLineWidth(2);
    ...
    // leg_entry = leg->AddEntry(HZjets, "Zjets2", "f");
    //  Add custom legend entries for Zjets0 and Zjets1
    // TH1F *dummy_Zjets0 = new TH1F("dummy_Zjets0", "", 0, 0, 1);
    // dummy_Zjets0->SetFillColor(46);

    // leg_entry = leg->AddEntry(dummy_Zjets0, "Zjets0 scaled", "f");

    // TH1F *dummy_Zjets1 = new TH1F("dummy_Zjets1", "", 0, 0, 1);
    // dummy_Zjets1->SetFillColor(7);

    // leg_entry = leg->AddEntry(dummy_Zjets1, "Zjets1 scaled", "f");
    leg_entry = leg->AddEntry(HZjets, "Zjets2 scaled", "f");
    // leg_entry = leg->AddEntry(HZjetsscaled, "Zjets2 scaled", "f");
